...
import { fetchInvestmentTypes, fetchBrokers, fetchNatures, fetchIncomes, createInvestment, createInvestmentType, createRentability, fetchInvestmentNames } from "@/services/investmentService";
            ...
            <Dialog open={open} onOpenChange={setOpen}>
                ...
                <DialogContent>
                    ...
                    <div className="grid grid-cols-1 gap-4">
                        <Label>Data</Label>
                        <DatePicker selectedDate={newInvestment.date} onSelect={(date) => setNewInvestment({ ...newInvestment, date: date ?? new Date() })} />
                ...
                <DialogContent className="max-w-md sm:max-w-lg w-full p-4 sm:p-6">
                    ...
                    <div className="grid grid-cols-1 gap-4">
                        ...
                        <DatePicker
                            ...
                            onSelect={(date) => setNewRentability({ ...newRentability, initial_date: date ?? new Date() })}
                        />

                        <Label>Data Final</Label>
                        <DatePicker
                            selectedDate={newRentability.final_date}
                            onSelect={(date) => setNewRentability({ ...newRentability, final_date: date ?? new Date() })}
                        />
